...
objects.set('DSH-Sync/releases/dsh-cloud-sync/0.18.2.tgz', sameVersionRevision)
objects.set('DSH-Sync/releases/dsh-cloud-sync/latest.json', Buffer.from(JSON.stringify({ packageName: '@dsh-local/dsh-cloud-sync', version: '0.18.2', objectKey: 'releases/dsh-cloud-sync/0.18.2.tgz', sha256: createHash('sha256').update(sameVersionRevision).digest('hex'), createdAt: new Date().toISOString() })))
